...
Complete source code on GitHub: [JavaScript](https://github.com/ONLYOFFICE/docspace-samples/blob/master/js-sdk/advanced-samples/get-config.html)
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Trigger Button -->
    <button id="button">Get Config</button>
  </body>
  ...
  <script>
    function onAppReady() {
      ...
      document.getElementById("button").onclick = async () => {
        let cfg = await docSpace.getConfig();
        console.log(cfg);
      };
    }
...
Create a simple HTML page with an embedded DocSpace frame and a button to trigger the configuration retrieval:
